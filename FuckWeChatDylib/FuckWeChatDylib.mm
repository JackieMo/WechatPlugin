...
@class SayHelloDataLogic; @class NewSettingViewController; @class WCDeviceStepObject; @class CMessageWrap; @class CMessageMgr; @class MMTableViewSectionInfo; @class SettingUtil; @class FriendAsistSessionMgr; @class MMServiceCenter; @class MMTableViewCellInfo; @class MMNewSessionMgr; @class CContactVerifyLogic; @class AutoSetRemarkMgr; @class CVerifyContactWrap; 
