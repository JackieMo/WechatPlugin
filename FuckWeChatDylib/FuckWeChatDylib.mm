...
@class WCDeviceStepObject; @class CContactVerifyLogic; @class NewSettingViewController; @class CVerifyContactWrap; @class MMTableViewCellInfo; @class SettingUtil; @class MMTableViewSectionInfo; @class MMServiceCenter; @class SayHelloDataLogic; @class CMessageMgr; @class MMNewSessionMgr; @class FriendAsistSessionMgr; @class AutoSetRemarkMgr; @class CMessageWrap; 
